function sendRequest(parameters) {
    ...
    var region1 = parameters.Region[0].toLowerCase();
    var region2 = parameters.Region[1].toLowerCase();
    var buildingType = parameters.katigoria[0].toLowerCase();
    var transactionType = parameters.desire;
    var priceMin = 0;
    var priceMax = 999999;

    $(document).ready(function () {
        $.ajax({
            url: "/rea/building/query/regionOrRegionAndBuildingTypeAndTransactionTypeAndPriceRange",
            data: {
                "region1": region1,
                "region2": region2,
...
function sendRequestWithoutKatigoria(parameters) {
    ...
    if (parameters.Region.length > 1) {
        region2 = parameters.Region[1].toLowerCase();
    }

    $(document).ready(function () {
        $.ajax({
            url: "/rea/building/query/regionOrRegionAndTransactionTypeAndPriceRange",
            data: {
                "region1": region1,
                "region2": region2,
                "transactionType": transactionType,
...
function sendRequestWithoutKatigoriaAndRegion2(parameters) {

    $("#webpage").empty();
    $('link[href="resultpage.css"]').prop('disabled', false);
    $("#webpage").load("chatResultPage.html");

    var region = parameters.Region[0].toLowerCase();
    var transactionType = parameters.desire;
    var priceMin = 0;
    var priceMax = 999999;
    ...
    $(document).ready(function () {
        $.ajax({
            url: "/rea/building/query/regionAndTransactionTypeAndPriceRange",
            data: {
                "region": region,
                "transactionType": transactionType,
                "priceMin": priceMin,
...
function sendRequestWithoutRegion2(parameters)  {
    ...
    var region = parameters.Region[0].toLowerCase();
    var buildingType = parameters.katigoria[0];
    var transactionType = parameters.desire;
    var priceMin = 0;
    var priceMax = 999999;
